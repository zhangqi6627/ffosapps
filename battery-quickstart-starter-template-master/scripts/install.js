...
if('mozApps' in navigator) {
  ...
  var manifest_url = '/manifest.webapp'; //这个路径是不是有问题??
  manifest_url = location.href.substring(0, location.href.lastIndexOf("/")) + "/manifest.webapp";

  console.log("location:" + manifest_url);
  function install(ev) {
    ev.preventDefault();
    // install the app
    ...
    installLocFind.onerror = function() {
      ...
      alert(installLocFind.error.name+":"+manifest_url);
    };
  };
